...
exports.updatePassword = asyncHandler(async (req, res, next) => {
    ...
    if (!(await user.checkPasswordMatch(req.body.currentPassword))) {
...
const sendTokenResponse = (user, statusCode, res) => {
    ...
    let dayToMiliseconds = hours * mins * seconds * miliseconds;

    const options = {
        expires: new Date(
            Date.now() + process.env.JWT_COOKIE_EXPIRE * dayToMiliseconds
        ),
        httpOnly: true,
    };
